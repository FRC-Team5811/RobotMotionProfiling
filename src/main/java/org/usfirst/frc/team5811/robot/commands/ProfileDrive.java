...
import org.usfirst.frc.team5811.robot.MotionProfiling.DCMotorTransmission;
import org.usfirst.frc.team5811.robot.MotionProfiling.DifferentialDrivePeter;
...
public class ProfileDrive extends Command {
    ...
    protected void execute() {
    	if(i<index) {
    		...
    		//DD.composeTransformFromArcs(5, 5).toText();
    		i++;
    	}else {
